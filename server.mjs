...
export function validateState(input){
  ...
  const products=input.products.map(p=>{
    ...
    if(typeof item.whatsapp_enabled!=='boolean')throw fail(400,'Revisa el canal de WhatsApp del producto.');
